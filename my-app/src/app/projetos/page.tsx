...
export default function page() {
  ...
  return (
    <div>
      ...
      <CardSection sectionName="">
        <SmallCard title="Cardápio Digital" date="14/06/2023" description="Faculdade" src="/rangotop.webp" stack={[dotnetStack]} siteUrl="" showSiteButton={false} repoUrl="https://github.com/felipetega/ProjetoIntegrador-FATEC" showInButton={false} inUrl=""/>
      </CardSection>
